...
function Tours() {
  ...
  const fetchTours = async () => {
    try {
      ...
      const { data, error } = await supabase
        .from("tours")
        .select(
          "id, title, description, price, duration, location, rating, highlights, features, image, sub_images, max_capacity, available, created_at"
        )
        .eq("available", true)
      ...
      console.log("Fetched tours:", toursWithImageUrls);
  ...
  const getImageUrl = (imagePath) => {
    ...
    try {
      ...
      console.log("Generated public URL for", imagePath, ":", data.publicUrl);
      return (
        data.publicUrl ||
  ...
  const handleBookingSubmit = async (e) => {
    ...
    try {
      ...
      if (error) throw error;
      setSuccessMessage(
        "Booking successful! We will contact you shortly to confirm."
      );
      setShowSuccessModal(true);
  ...
  const tourCategories = [
    {
      ...
      description:
        "Explore pristine islands and hidden beaches across the Philippine archipelago.",
      count: `${
        tours.filter(
          (t) => t.type === "regular" && t.location.toLowerCase().includes("island")
        ).length
      } Tours`,
    },
    {
      ...
      description:
        "Discover rich Filipino history and traditional cultural sites.",
      count: `${
        tours.filter((t) => t.location.toLowerCase().includes("city")).length
      } Tours`,
    },
    {
      icon: "🤿",
      ...
      description:
        "Dive into crystal-clear waters and encounter marine life.",
      count: `${
        tours.filter((t) =>
          t.highlights?.some(
            (h) => h.toLowerCase().includes("snorkel") || h.toLowerCase().includes("diving")
          )
        ).length
      } Tours`,
    },
    {
      ...
      count: `${
        tours.filter((t) =>
          t.highlights?.some(
            (h) => h.toLowerCase().includes("adventure") || h.toLowerCase().includes("canyoneering")
          )
        ).length
      } Tours`,
    },
  ...
  const whyBookItems = [
    {
      ...
      desc: "Born and raised guides who know every hidden gem and secret spot in the Philippines.",
    },
    {
      icon: "M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z",
      title: "Best Prices",
      desc: "Competitive pricing with no hidden fees. Get the best value for your money.",
    },
    {
      icon: "M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z",
      title: "Customer Care",
      desc: "24/7 support and personalized service to ensure your trip exceeds expectations.",
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-50" style={{ fontFamily: "system-ui, -apple-system, sans-serif" }}>
      ...
      <button
        ...
        className="fixed bottom-4 right-4 bg-[#00355f] text-white p-4 rounded-full shadow-lg hover:bg-[#004a84] transition-colors duration-300 z-40"
      >
        <FaRobot size={24} />
      </button>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        <div
          ...
          style={{
            backgroundImage:
              "url('https://images.unsplash.com/photo-1544551763-46a013bb70d5?ixlib=rb-4.0.3')",
          }}
        >
          <div
        ...
        <div className="relative z-10 text-center max-w-6xl mx-auto px-6">
          <span
            className="inline-block px-5 py-2 rounded-full text-sm font-medium tracking-wide text-white/95 bg-[#eec218]"
            style={{ color: "#00355f" }}
          >
            TOUR PACKAGES
          </span>
          ...
          <p className="text-xl md:text-2xl mb-12 max-w-4xl mx-auto font-normal leading-relaxed text-white/95">
            Discover the beauty of the Philippines with our carefully curated tour
            packages. From pristine beaches to cultural heritage sites.
          </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-700 max-w-3xl mx-auto font-normal">
              Handpicked experiences that showcase the best of Cebu and
              surrounding islands
            </p>
          </div>
          {loading && (
          ...
          {error && (
            <div className="text-center py-20">
              ...
              <button
                onClick={fetchTours}
                className="px-6 py-3 rounded-lg text-white font-semibold transition-all duration-300 hover:bg-[#004a84]"
              ...
              <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
                {tours.map((tour) => (
                  <div key={tour.id} className="group">
                    <div className="bg-white/95 backdrop-blur-sm rounded-xl overflow-hidden hover:shadow-lg hover:-translate-y-1 transition-all duration-300 border border-gray-200/50">
                      <div className="relative overflow-hidden">
                        <img
                          ...
                          onError={(e) => {
                            console.warn(
                              `Image failed to load for tour: ${tour.title}, using fallback`
                            );
                            e.target.src =
                              "https://images.unsplash.com/photo-1506905925346-21bda4d32df4?ixlib=rb-4.0.3";
                          }}
                        ...
                        <div
                          className="absolute top-4 left-4 bg-[#eec218] px-3 py-1 rounded-lg pointer-events-none"
                        >
                          <span
                        ...
                        <div className="absolute bottom-4 left-4 bg-white/95 backdrop-blur-sm px-3 py-1 rounded-lg pointer-events-none">
                          <span
                            className="text-sm font-medium"
                            style={{ color: "#00355f" }}
                          >
                            Max: {tour.max_capacity || 20}
                          </span>
                        </div>
                        <div className="absolute bottom-4 right-4 bg-white/95 backdrop-blur-sm px-3 py-1 rounded-lg pointer-events-none">
                          <span
                            className={`text-sm font-medium ${
                      ...
                      <div className="p-6">
                        <div className="flex justify-between items-start mb-3">
                          <h3
                            className="text-xl font-semibold group-hover:opacity-80 transition-opacity"
                            style={{ color: "#00355f" }}
                          >
                            {tour.title}
                          </h3>
                          <span className="text-sm text-gray-600 bg-gray-100/80 px-3 py-1 rounded-lg font-medium">
                            {tour.duration}
                          </span>
                        </div>
                        ...
                        {tour.highlights?.length > 0 && (
                          <div className="flex flex-wrap gap-2 mb-6">
                            {tour.highlights.slice(0, 3).map((h, i) => (
                              <span
                                key={i}
                                className="text-xs px-2 py-1 rounded-lg border bg-white/50"
                                style={{
                                  color: "#00355f",
                                  borderColor: "#e9ecef",
                                }}
                            ...
                            {tour.highlights.length > 3 && (
                              <span
                                className="text-xs px-2 py-1 rounded-lg border text-gray-500 bg-white/50"
                                style={{
                                  borderColor: "#e9ecef",
                                }}
                              >
                        ...
                        <button
                          className="w-full py-3 text-white font-semibold rounded-lg hover:bg-[#004a84] transition-all duration-300 disabled:bg-gray-400 disabled:cursor-not-allowed"
                          style={{ backgroundColor: "#00355f" }}
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-700 max-w-3xl mx-auto font-normal">
              Choose from our diverse range of tour experiences tailored to every
              type of traveler
            </p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {tourCategories.map((category, i) => (
              <div key={i} className="text-center group cursor-pointer">
                <div className="bg-white/95 backdrop-blur-sm border border-gray-200/50 rounded-xl p-8 hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
                  ...
                  <p className="text-gray-600 leading-relaxed font-normal mb-4">
                    {category.description}
                  </p>
                  <span
                    className="text-sm font-medium px-3 py-1 rounded-lg bg-white/50"
                    style={{ color: "#00355f" }}
                  >
                    {category.count}
                  </span>
      ...
      <section className="py-20 px-6 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-700 max-w-3xl mx-auto font-normal">
              Experience the difference with our professional service and local
              expertise
            </p>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
            {whyBookItems.map((item, i) => (
              <div key={i} className="text-center group">
                <div className="bg-white/95 backdrop-blur-sm rounded-xl p-8 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 border border-gray-200/50">
                  <div
      ...
      <section className="py-20 px-6" style={{ backgroundColor: "#00355f" }}>
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-white/90 mb-12 font-normal">
            Contact us today to customize your perfect Philippine getaway. Our
            experienced guides are ready to make your trip unforgettable.
          </p>
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            <button
              onClick={() => navigate("/contact")}
              className="px-8 py-4 font-semibold rounded-lg transition-all duration-300 shadow-lg transform hover:scale-105"
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-sm text-gray-400">
              Professional tours and transportation services to make your Cebu
...
const Modals = ({
        ...
        {show ? (
          ...
          >
            <path
              ...
              strokeLinejoin="round"
              strokeWidth="2"
              d="M13.875 18.825A10.05 10.05 0 0112 19c-4.418 0-8-3.582-8-8s3.582-8 8-8c1.675 0 3.245.516 4.575 1.41M15 12a3 3 0 11-6 0 3 3 0 016 0zm6.75 0h.008v.008h-.008V12zm-18 0h-.008v.008h.008V12z"
            />
          </svg>
        ) : (
          <svg
  ...
  return (
    <>
        ...
        >
          <form onSubmit={handleAuth} className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setAuthForm({ ...authForm, middleInitial: e.target.value })
                    }
                    maxLength={1}
                    className="w-full px-4 py-2.5 bg-white/50 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#eec218] focus:border-[#eec218] transition-all placeholder-gray-400"
                    placeholder="M.I."
            ...
            <button
              ...
              className="w-full py-3 font-semibold rounded-lg transition-all duration-300 text-white transform hover:scale-105"
              style={{
                backgroundColor: authLoading ? "#9ca3af" : "#00355f",
              }}
              onMouseEnter={(e) =>
                !authLoading && (e.currentTarget.style.backgroundColor = "#004a84")
              }
              onMouseLeave={(e) =>
                !authLoading && (e.currentTarget.style.backgroundColor = "#00355f")
              }
            >
              {authLoading
                ? "Please wait..."
        ...
        >
          ...
          <div className="flex justify-end space-x-4">
            <button
              ...
              className="px-5 py-2.5 text-gray-600 bg-white/50 border border-gray-300 rounded-lg hover:bg-opacity-70 transition-all duration-300"
            >
              Cancel
            </button>
            <button
              onClick={handleLogout}
              className="px-4 py-2 rounded-lg font-medium transition-all duration-300 text-white transform hover:scale-105"
              style={{ backgroundColor: "#00355f" }}
      ...
      {showErrorModal && (
        <Modal show={showErrorModal} setShow={setShowErrorModal} title="Error">
    ...
    >
      <div className="space-y-6" ref={modalRef}>
        ...
        <div className="flex justify-start">
          <span
            className="inline-block px-5 py-2 rounded-lg font-semibold text-base bg-[#eec218]"
            style={{ color: "#00355f" }}
          >
            {tour.formattedPrice}
          </span>
